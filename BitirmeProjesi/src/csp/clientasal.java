...
int flag=0;
for(int i=(int) ((Math.sqrt(Integer.parseInt(sayi))/Integer.parseInt(ajanSayisi))*(ajanNo-1));i<=(Math.sqrt(Integer.parseInt(sayi))/Integer.parseInt(ajanSayisi))*ajanNo;i++){
